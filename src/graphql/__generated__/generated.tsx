...
export type SignupMutation = { __typename?: 'Mutation' } & {
    signup: { __typename?: 'Auth' } & Pick<Auth, 'token'> & {
            user: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'name' | 'school'> & {
                    timetables?: Maybe<
                        Array<Maybe<{ __typename?: 'Timetable' } & Pick<Timetable, 'id'>>>
                    >;
                };
        };
};
...
export type LoginMutation = { __typename?: 'Mutation' } & {
    login: { __typename?: 'Auth' } & Pick<Auth, 'token'> & {
            user: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'name' | 'school'> & {
                    timetables?: Maybe<
                        Array<Maybe<{ __typename?: 'Timetable' } & Pick<Timetable, 'id'>>>
                    >;
...
export type UpdateLoginUserMutation = { __typename?: 'Mutation' } & {
    updateLoginUser: { __typename?: 'Auth' } & Pick<Auth, 'token'> & {
            user: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'name' | 'school'> & {
                    timetables?: Maybe<
                        Array<Maybe<{ __typename?: 'Timetable' } & Pick<Timetable, 'id'>>>
                    >;
...
export type DeleteLoginUserMutation = { __typename?: 'Mutation' } & Pick<
    Mutation,
    'deleteLoginUser'
>;
...
export type CreateTimetableMutation = { __typename?: 'Mutation' } & {
    createTimetable: { __typename?: 'Timetable' } & Pick<
        Timetable,
...
export type UpdateTimetableMutation = { __typename?: 'Mutation' } & {
    updateTimetable: { __typename?: 'Timetable' } & Pick<
        Timetable,
        'id' | 'name' | 'days' | 'periods' | 'createdAt' | 'updatedAt' | 'isDefault'
    >;
};
...
export type DeleteTimetableMutation = { __typename?: 'Mutation' } & Pick<
    Mutation,
    'deleteTimetable'
>;
...
export type CreateClasstimeMutation = { __typename?: 'Mutation' } & {
    createClassTime: { __typename?: 'ClassTime' } & Pick<
        ClassTime,
...
export type UpdateClassTimeMutation = { __typename?: 'Mutation' } & {
    updateClassTime: { __typename?: 'ClassTime' } & Pick<
        ClassTime,
        'id' | 'period' | 'startTime' | 'endTime'
    >;
};
...
export type CreateClassMutation = { __typename?: 'Mutation' } & {
    createClass: { __typename?: 'Class' } & Pick<
        Class,
        | 'id'
        | 'name'
        | 'day'
...
export type UpdateClassMutation = { __typename?: 'Mutation' } & {
    updateClass: { __typename?: 'Class' } & Pick<
        Class,
        | 'id'
        | 'name'
        | 'day'
...
export type DeleteClassMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'deleteClass'>;
...
export type UpdateTodoMutation = { __typename?: 'Mutation' } & {
    updateTodo: { __typename?: 'Todo' } & Pick<
        Todo,
        'id' | 'kind' | 'deadline' | 'isDone' | 'isRepeated' | 'memo'
    >;
};
...
export type CreateUrlMutation = { __typename?: 'Mutation' } & {
    createUrl: { __typename?: 'Url' } & Pick<Url, 'id' | 'name' | 'url'>;
};
...
export type UpdateUrlMutation = { __typename?: 'Mutation' } & {
    updateUrl: { __typename?: 'Url' } & Pick<Url, 'id' | 'name' | 'url'>;
};
...
export type DeleteUrlMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'deleteUrl'>;

export type GetLoginUserDataQueryVariables = Exact<{ [key: string]: never }>;

export type GetLoginUserDataQuery = { __typename?: 'Query' } & {
    user: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'name' | 'school'> & {
            timetables?: Maybe<
                Array<
                    Maybe<
...
export type GetDefaultTimetableQuery = { __typename?: 'Query' } & {
    timetable: { __typename?: 'Timetable' } & Pick<
        Timetable,
        'id' | 'name' | 'days' | 'periods' | 'createdAt' | 'updatedAt' | 'isDefault'
    > & {
            rowData?: Maybe<
                Array<
                    Maybe<
                        { __typename?: 'TimetableRowData' } & Pick<
                            TimetableRowData,
...
export type GetTodosByGivenTimetableIdQuery = { __typename?: 'Query' } & {
    todos?: Maybe<
        Array<
            Maybe<
                { __typename?: 'Todo' } & Pick<
...
`;
export type UpdateLoginUserMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateLoginUserMutation(
    baseOptions?: Apollo.MutationHookOptions<
        UpdateLoginUserMutation,
        UpdateLoginUserMutationVariables
    >
) {
    return Apollo.useMutation<UpdateLoginUserMutation, UpdateLoginUserMutationVariables>(
        UpdateLoginUserDocument,
        baseOptions
    );
}
...
export type UpdateLoginUserMutationOptions = Apollo.BaseMutationOptions<
    UpdateLoginUserMutation,
    UpdateLoginUserMutationVariables
>;
...
`;
export type DeleteLoginUserMutationFn = Apollo.MutationFunction<
    DeleteLoginUserMutation,
    DeleteLoginUserMutationVariables
>;
 ...
 * });
 */
export function useDeleteLoginUserMutation(
    baseOptions?: Apollo.MutationHookOptions<
        DeleteLoginUserMutation,
        DeleteLoginUserMutationVariables
    >
) {
    return Apollo.useMutation<DeleteLoginUserMutation, DeleteLoginUserMutationVariables>(
        DeleteLoginUserDocument,
        baseOptions
    );
}
...
export type DeleteLoginUserMutationOptions = Apollo.BaseMutationOptions<
    DeleteLoginUserMutation,
    DeleteLoginUserMutationVariables
>;
...
`;
export type CreateTimetableMutationFn = Apollo.MutationFunction<
...
export function useCreateTimetableMutation(
    ...
    return Apollo.useMutation<CreateTimetableMutation, CreateTimetableMutationVariables>(
        CreateTimetableDocument,
        baseOptions
    );
}
...
export type CreateTimetableMutationOptions = Apollo.BaseMutationOptions<
    CreateTimetableMutation,
    CreateTimetableMutationVariables
>;
...
`;
export type UpdateTimetableMutationFn = Apollo.MutationFunction<
...
export function useUpdateTimetableMutation(
    ...
    return Apollo.useMutation<UpdateTimetableMutation, UpdateTimetableMutationVariables>(
...
export type UpdateTimetableMutationOptions = Apollo.BaseMutationOptions<
    UpdateTimetableMutation,
    UpdateTimetableMutationVariables
>;
...
`;
export type DeleteTimetableMutationFn = Apollo.MutationFunction<
    DeleteTimetableMutation,
    DeleteTimetableMutationVariables
>;
...
export function useDeleteTimetableMutation(
    ...
    return Apollo.useMutation<DeleteTimetableMutation, DeleteTimetableMutationVariables>(
...
export type DeleteTimetableMutationOptions = Apollo.BaseMutationOptions<
    DeleteTimetableMutation,
    DeleteTimetableMutationVariables
>;
...
`;
export type CreateClasstimeMutationFn = Apollo.MutationFunction<
    CreateClasstimeMutation,
    CreateClasstimeMutationVariables
>;
 ...
 * });
 */
export function useCreateClasstimeMutation(
    baseOptions?: Apollo.MutationHookOptions<
        CreateClasstimeMutation,
        CreateClasstimeMutationVariables
    >
) {
    return Apollo.useMutation<CreateClasstimeMutation, CreateClasstimeMutationVariables>(
        CreateClasstimeDocument,
        baseOptions
    );
}
...
export type CreateClasstimeMutationOptions = Apollo.BaseMutationOptions<
    CreateClasstimeMutation,
    CreateClasstimeMutationVariables
>;
...
`;
export type UpdateClassTimeMutationFn = Apollo.MutationFunction<
    UpdateClassTimeMutation,
    UpdateClassTimeMutationVariables
>;
 ...
 * });
 */
export function useUpdateClassTimeMutation(
    baseOptions?: Apollo.MutationHookOptions<
        UpdateClassTimeMutation,
        UpdateClassTimeMutationVariables
    >
) {
    return Apollo.useMutation<UpdateClassTimeMutation, UpdateClassTimeMutationVariables>(
        UpdateClassTimeDocument,
        baseOptions
    );
}
...
export type UpdateClassTimeMutationOptions = Apollo.BaseMutationOptions<
    UpdateClassTimeMutation,
    UpdateClassTimeMutationVariables
>;
...
export function useCreateClassMutation(
    baseOptions?: Apollo.MutationHookOptions<CreateClassMutation, CreateClassMutationVariables>
) {
...
export function useUpdateClassMutation(
    baseOptions?: Apollo.MutationHookOptions<UpdateClassMutation, UpdateClassMutationVariables>
) {
...
export function useDeleteClassMutation(
    baseOptions?: Apollo.MutationHookOptions<DeleteClassMutation, DeleteClassMutationVariables>
) {
...
`;
export type CreateUrlMutationFn = Apollo.MutationFunction<
    CreateUrlMutation,
...
export function useCreateUrlMutation(
    baseOptions?: Apollo.MutationHookOptions<CreateUrlMutation, CreateUrlMutationVariables>
) {
    return Apollo.useMutation<CreateUrlMutation, CreateUrlMutationVariables>(
        CreateUrlDocument,
        baseOptions
    );
}
...
export type CreateUrlMutationOptions = Apollo.BaseMutationOptions<
    CreateUrlMutation,
    CreateUrlMutationVariables
>;
...
export function useUpdateUrlMutation(
    baseOptions?: Apollo.MutationHookOptions<UpdateUrlMutation, UpdateUrlMutationVariables>
) {
 ...
 * });
 */
export function useGetLoginUserDataQuery(
    baseOptions?: Apollo.QueryHookOptions<GetLoginUserDataQuery, GetLoginUserDataQueryVariables>
) {
    return Apollo.useQuery<GetLoginUserDataQuery, GetLoginUserDataQueryVariables>(
        GetLoginUserDataDocument,
        baseOptions
    );
}
export function useGetLoginUserDataLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetLoginUserDataQuery, GetLoginUserDataQueryVariables>
) {
    return Apollo.useLazyQuery<GetLoginUserDataQuery, GetLoginUserDataQueryVariables>(
        GetLoginUserDataDocument,
        baseOptions
    );
}
...
export type GetLoginUserDataQueryResult = Apollo.QueryResult<
    GetLoginUserDataQuery,
    GetLoginUserDataQueryVariables
>;
 ...
 * });
 */
export function useGetDefaultTimetableQuery(
    baseOptions?: Apollo.QueryHookOptions<
        GetDefaultTimetableQuery,
        GetDefaultTimetableQueryVariables
    >
) {
    return Apollo.useQuery<GetDefaultTimetableQuery, GetDefaultTimetableQueryVariables>(
        GetDefaultTimetableDocument,
        baseOptions
    );
}
export function useGetDefaultTimetableLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GetDefaultTimetableQuery,
        GetDefaultTimetableQueryVariables
    >
) {
    return Apollo.useLazyQuery<GetDefaultTimetableQuery, GetDefaultTimetableQueryVariables>(
        GetDefaultTimetableDocument,
        baseOptions
    );
}
export type GetDefaultTimetableQueryHookResult = ReturnType<typeof useGetDefaultTimetableQuery>;
export type GetDefaultTimetableLazyQueryHookResult = ReturnType<
    typeof useGetDefaultTimetableLazyQuery
>;
export type GetDefaultTimetableQueryResult = Apollo.QueryResult<
    GetDefaultTimetableQuery,
    GetDefaultTimetableQueryVariables
>;
 ...
 * });
 */
export function useGetTodosByGivenTimetableIdQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetTodosByGivenTimetableIdQuery,
        GetTodosByGivenTimetableIdQueryVariables
    >
) {
    return Apollo.useQuery<
        GetTodosByGivenTimetableIdQuery,
        GetTodosByGivenTimetableIdQueryVariables
    >(GetTodosByGivenTimetableIdDocument, baseOptions);
}
export function useGetTodosByGivenTimetableIdLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GetTodosByGivenTimetableIdQuery,
        GetTodosByGivenTimetableIdQueryVariables
    >
...
export type GetTodosByGivenTimetableIdQueryHookResult = ReturnType<
    typeof useGetTodosByGivenTimetableIdQuery
>;
export type GetTodosByGivenTimetableIdLazyQueryHookResult = ReturnType<
    typeof useGetTodosByGivenTimetableIdLazyQuery
>;
export type GetTodosByGivenTimetableIdQueryResult = Apollo.QueryResult<
    GetTodosByGivenTimetableIdQuery,
    GetTodosByGivenTimetableIdQueryVariables
>;
